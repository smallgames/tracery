	...
	var Unslider = function() {
		...
		_.o = {
			speed : 500, // animation speed, false for no transition (integer
							// or boolean)
			delay : 3000, // delay between slides, false for no autoplay
							// (integer or boolean)
			...
			autoplay : true
		// enable autoplay on initialisation
		};
				...
				$(window).resize(
						function() {
							...
							_.r = setTimeout(function() {
								...
								ul.css(styl);
								styl['width'] = Math.min(Math.round((width / el
										.parent().width()) * 100), 100)
										+ '%';
								el.css(styl);
								li.css({
									width : width + 'px'
